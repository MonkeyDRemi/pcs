...
<head>
    ...
    <title>PCS</title>
    <link rel="stylesheet" href="../styles_bien.css">
...
<script src="//code.tidio.co/tja2ulfqsonx4dvvp2ectazlfg1hn7ul.js" async></script>
<body>
    <header>
        <div class="logo">
    ...
    <ul>
        ...
        <li><a href="../accueil/switch_theme.php?theme=light">Changer de Thème</a></li>
